...
import RecordingSession from "./src/models/RecordingSession.js";
import { getDriveClient } from "./src/services/driveService.js";
...
async function runTest() {
  try {
    ...
    const dummyAudio = Buffer.from("ebml-dummy-data"); 
