export const FONTS = ["Inter", "Georgia", "monospace", "Arial", "Courier New", "Times New Roman", "Gloria Hallelujah"];
...
export const DEFAULT_ELEMENT_STYLES = {
    ...
    line: { fill: "none", stroke: "#1e1e1e", strokeWidth: 3, textColor: "#1e1e1e", fontSize: 14, fontFamily: "Inter", textAlign: "center", textVerticalAlign: "middle" },
