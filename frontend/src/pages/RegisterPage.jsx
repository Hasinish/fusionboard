...
function RegisterPage() {
  ...
  return (
    <div className="min-h-screen w-screen bg-[#F2E6D2] flex flex-col md:flex-row overflow-y-auto md:overflow-hidden font-sans">
      ...
      <div className="w-full md:w-[37%] flex flex-col justify-center p-8 md:p-12 lg:pr-20 lg:pl-0">
        <div className="max-w-[400px] mx-auto w-full">
          ...
          <div className="w-full text-center mb-10">
            ...
            <h2 className="text-[28px] font-bold text-[#1A1A2E] leading-tight mb-8 tracking-tight font-display">Create Account</h2>
          </div>
